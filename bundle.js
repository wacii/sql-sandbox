...
/***/ function(module, exports, __webpack_require__) {
	...
	var init = function init() {
	  ...
	  var lesson = new Lesson(__webpack_require__(19));
...
/***/ function(module, exports, __webpack_require__) {
	...
	function setup(db, logEl, currentStep, nextStep, commandHistory, clearInput) {
	  ...
	  var log = __webpack_require__(13)(logEl);
	  var logCommand = log.command;
	  var logError = log.error;
	  var logPrompt = log.prompt;
	  var logResults = log.results;

	  var rememberCommand = __webpack_require__(15)(commandHistory);
	  var enterPressed = __webpack_require__(16)(currentStep, nextStep);
	  var expectation = __webpack_require__(17)(currentStep, nextStep, logPrompt);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Stack = __webpack_require__(8),
	    ...
	    baseFor = __webpack_require__(11),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var compareResults = __webpack_require__(18);
...
/***/ function(module, exports) {
	...
	module.exports = {
		...
		"steps": [{
			...
			"type": "prompt",
			"text": "Fetch all products with manufacturer_id of 1."
		}, {
			"type": "checkResults",
			"expectations": [{
				"type": "values",
